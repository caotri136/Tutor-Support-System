  ...
  return (
    <div className="admin-dashboard-container">
      ...
      <aside className="admin-sidebar">
        <div>
          <h2 className="sidebar-title">Văn phòng OAA</h2>
          <p className="sidebar-subtitle">
            Quản lý phân bổ và báo cáo
          </p>
        </div>
        ...
        <div className="sidebar-actions">
          ...
          >
            <span className="sidebar-text">Báo cáo phân bổ</span>
          </Link>
        </div>
      </aside>
      ...
      <main className="admin-main-content">
        <div className="logo-wrapper">
          ...
          <h1 className="welcome-text">Chào mừng Văn phòng OAA</h1>
